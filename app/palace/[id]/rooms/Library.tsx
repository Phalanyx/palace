  ...
  return (
    <>
      ...
      {objects.slice(0, 5).map((obj, i) => (
        <DynamicObject key={obj.id} objectData={obj} position={LIBRARY_SLOTS[i]} forceOpen={i === activeObjectIdx} onClose={onCloseObject} onObjectOpen={onObjectOpen} onObjectClose={onObjectClose} mode={mode} />
      ))}
    </>
  );
}
